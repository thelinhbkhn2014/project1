...
public class UserSql {
    ...
    public static User signIn(String userId, String password){
        ...
        try {
            ...
            rs = ps.executeQuery();
            while(rs.next()){
                user = new User(userId, password, rs.getString("UserName"), rs.getDate("BirthDay"),rs.getString("class"));
            }
    ...
    public static boolean updateUser(User user){
        String sql = "UPDATE Users SET Password = ?, UserName = ?, BirthDay = ?, Class = ? WHERE UserId = ?";
